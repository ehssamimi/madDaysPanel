...
import FormGameMode from "./subcomponents-twoTabs/FormGameMode";
import ShowGameMode from "./subcomponents-twoTabs/ShowGameMode";


class TabCardGameMode extends Component {
    constructor(props) {
        super(props);
...
export default TabCardGameMode;