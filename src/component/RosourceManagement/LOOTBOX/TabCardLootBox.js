...
import FormAddLootBox from "./SubComponents/FromAddLootBox";
import ShowLootBox from "./SubComponents/ShowLootBox";

class TabCardLootBox extends Component {
    constructor(props) {
        super(props);
