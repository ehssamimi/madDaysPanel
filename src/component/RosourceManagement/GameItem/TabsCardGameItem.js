...
import FormGameItem from "../GameItem/subcomponentsTwoTabs/FormGameItem";
import ShowGameItem from "../GameItem/subcomponentsTwoTabs/ShowGameItem";

class TabsCardGameItem extends Component {
    constructor(props) {
        super(props);
...
export default TabsCardGameItem;